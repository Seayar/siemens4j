package tk.seayar.siemens4j.core.net.networkbase;

import tk.seayar.siemens4j.basic.SoftBasic;
import tk.seayar.siemens4j.core.imessage.INetMessage;
import tk.seayar.siemens4j.core.net.stateone.AlienSession;
import tk.seayar.siemens4j.core.thread.SimpleHybirdLock;
import tk.seayar.siemens4j.core.transfer.ByteTransformHelper;
...
public class NetworkDoubleBase<TNetMessage extends INetMessage  ,TTransform extends IByteTransform> extends NetworkBase
{
    ...
    public OperateResult ConnectServer( )
    {
        ...
        else
        {
            ...
            if(LogNet != null) LogNet.WriteDebug( toString( ), MessageString.NetEngineStart() );
        }
    ...
    public OperateResult ConnectClose( )
    {
        ...
        if(LogNet != null ) LogNet.WriteDebug( toString( ), MessageString.NetEngineClose() );
        return result;
    }
