package xyz.seayar.siemens4j.core.types;
...
public class OperateResultExThree<T1, T2, T3> extends OperateResult {
     ...
     * @return 结果类对象
     */
    public static <T1, T2, T3> OperateResultExThree<T1, T2, T3> CreateSuccessResult(T1 content1, T2 content2, T3 content3, byte content4) {
     ...
     * @return 结果类对象
     */
    public static <T1, T2, T3> OperateResultExThree CreateFailedResult(OperateResult result) {
