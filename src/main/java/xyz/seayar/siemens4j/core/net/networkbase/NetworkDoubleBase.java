package xyz.seayar.siemens4j.core.net.networkbase;

import xyz.seayar.siemens4j.basic.SoftBasic;
import xyz.seayar.siemens4j.core.imessage.INetMessage;
import xyz.seayar.siemens4j.core.net.stateone.AlienSession;
import xyz.seayar.siemens4j.core.thread.SimpleHybirdLock;
import xyz.seayar.siemens4j.core.transfer.ByteTransformHelper;
import xyz.seayar.siemens4j.core.transfer.IByteTransform;
...
public class NetworkDoubleBase<TNetMessage extends INetMessage, TTransform extends IByteTransform> extends NetworkBase {
    ...
    private final Class<TNetMessage> netMessageClass;           // 消息的泛型类对象
    private final Class<TTransform> tTransformClass;            // 转换的泛型类对象
     ...
     */
    public xyz.seayar.siemens4j.core.net.stateone.AlienSession AlienSession = null;
    ...
    public OperateResult ConnectServer( )
    {
        ...
        if (!rSocket.IsSuccess)
        {
            ...
            if (LogNet != null) {
                LogNet.WriteDebug(toString(), MessageString.NetEngineStart());
            }
        }
    ...
    public OperateResult ConnectClose( ) {
        ...
        if (LogNet != null) {
            LogNet.WriteDebug(toString(), MessageString.NetEngineClose());
        }
        return result;
    }
